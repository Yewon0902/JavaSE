 ...
 * 
 * 변수 선언 및 초기화
 * 자료형(type) 변수명 = 값, 참조클레스;
 * 
 * 1. 타입에 따른 변수
 *    기본형 - 예악어, 소문자로 시작, 직접 값을 저장하고 있다.
 *       8가지 - boolean, char, int, short, long, float, double
...
public class Var01 {
   ...
   public static void main(String[] args) {
	  ...
	  System.out.println("mian() 메서드 내에서 전역변수 호출: " + globalvar);
	  ...
	  int localVar1;
		//System.out.println("locaVar1: " + localVar1);
